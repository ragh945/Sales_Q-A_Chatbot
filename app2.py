...
# ---------------------------
# 6. Plotting function for top 10 rows
# ---------------------------
def plot_top10_bar(df):
    ...
    x_col = non_numeric_cols[0] if non_numeric_cols else df.index.name or "Index"
    ...
    sns.barplot(data=top10_df, x=x_col, y=y_col)
    ...
    if sql_query:
        ...
        try:
            ...
            if sql_result.empty:
                ...
                # Plot top 10 rows
                plot_top10_bar(sql_result)

                # Use Gemini LLM for summary
...
if st.session_state.chat_history:
    ...
    for i, entry in enumerate(st.session_state.chat_history):
        ...
        if entry.get('df') is not None:
            ...
            # Plot top 10 rows for history results
            plot_top10_bar(entry['df'])
        st.write("---")
